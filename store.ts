...
import { initialAuthReducerState, InitialAuthReducerStateInterface } from "./reducers/authReducer";
...
const initialStore: InitialStoreInterface = {
    auth: { ...initialAuthReducerState, token: tokenFromCookies, user: userFromCookies },
};
