...
const validateBearerToken = async (authorization: string): Promise<ValidateBearerTokenInterface> => {
    try {
...
const getUserIdAndBearerTokenFromAuth = (authorization: string): UserIdAndBearerTokenInterface | null => {
    try {
