...
import { continueIfAuthenticatedWithBearerToken, executeIfUserRequirementsMet } from "../../../utils/apiAuth";
...
export default async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    await continueIfAuthenticatedWithBearerToken(authorization, res, async (user, token) => {
        await executeIfUserRequirementsMet(user,
            [
